...
public class Atm {
  ...
  */
  public static void main(String [] args) {
    ...
    // create an instance of an offer
    Offer offer = new Offer(offerId, offerText);

    // create an instance of an Account
    Account account = new Account(accountNumber, balance, offer);
    ...
    // Now, perform the user defined action (either withdraw or deposit)
    if (action.equals("withdraw")) {
      System.out.println("Okay, you would like to withdraw $" + amount);
      account.withdraw(amount);
      System.out.println("Your updated balance is $" + account.getBalance());
    } else if (action.equals("deposit")) {
      System.out.println("Okay, you would like to deposit $" + amount);
      account.deposit(amount);
      System.out.println("Your updated balance is $" + account.getBalance());
    }

    // print out offer id and its text
    System.out.println("Offer id " + account.getOffer().getOfferId()
                      + ": " +       account.getOffer().getOfferText());
    // final message
